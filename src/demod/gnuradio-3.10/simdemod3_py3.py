...
import cmath
import os
import simdemod3_py3_send_udp_to_telive as send_udp_to_telive  # embedded python block




class simdemod3_py3(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "DQPSK demodulator for Telive", catch_exceptions=True)
...
def main(top_block_cls=simdemod3_py3, options=None):
    tb = top_block_cls()
